...
<nav class="openings-jump" aria-label="Openings page sections">
  ...
  <a href="#joint-training">Joint Training</a>
...
### Recommended-Admission Master's Students {#masters}
...
### Joint-Training Students {#joint-training}
...
### Visiting Scholars & Students {#visiting}
...
Please email your **CV** (with transcripts and representative publications or projects where applicable) to [`hwu202425@gmail.com`](mailto:hwu202425@gmail.com) and cc the lab supervisor at [`yuke.sz@pku.edu.cn`](mailto:yuke.sz@pku.edu.cn). A research proposal is optional.

Please use the following format for both the email subject and attachment name, replacing the category tag accordingly:

<p class="subject-line"><span>Format:</span><code>[Ph.D. / Master's / Postdoc / Joint Training / Visiting / Intern] Name-University-Major-Preferred Direction</code></p>
